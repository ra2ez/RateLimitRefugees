          ...
          <>
            <div style={s.grid}>
              <div style={s.card}>
                ...
                <p style={s.csub}>{paidCount} confirmed contributions</p>
              </div>
              <div style={s.card}>
            ...
            <div style={s.ratesCard}>
              ...
              <div style={s.ratesRow}>
                ...
                <div style={s.rateBox(false)}>
                  <span style={s.rateBoxLabel(false)}>Current Pool</span>
                  <span style={s.rateBoxValue(false)}>R {totalPool.toLocaleString()}</span>
              ...
              {totalPool > 0 ? (
                ...
                <p style={{ fontSize: '13px', color: '#9ca39a', margin: '4px 0 0' }}>
